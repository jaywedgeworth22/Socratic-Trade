> **2026-09-18 GROK — AG entry-path remainder (board 6aa1e66e).**  Keep callbackUrl; add authenticated login redirect and iOS first-run copy.  Extra-ship no.  No Coolify Deploy.  Rollout: `docs/rollouts/2026-09-18-ag-entry-paths.md`.
