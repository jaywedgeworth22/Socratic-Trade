...
> **2026-09-22 [MM] archaeology note:** historical reference to the iOS bundle ID `trade.socratic.app` is kept verbatim as it was live at rollout time.  Renamed on 2026-09-22 to `trade.socratic.ios` (PR forthcoming).  The Apple capability / provisioning steps in this rollout still apply — only the bundle ID string changes.  See `docs/rollouts/2026-09-22-bundle-id-migration.md`.
