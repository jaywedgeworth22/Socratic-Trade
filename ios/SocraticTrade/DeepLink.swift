...
enum DeepLink {
    ...
    static var universalLinkHost: String { MobileAPIClient.configuredBaseURL.host ?? "socratictrade.com" }
...
enum ConsoleHandoff {
    static let connections = MobileAPIClient.configuredBaseURL.appendingPathComponent("console/connections")
